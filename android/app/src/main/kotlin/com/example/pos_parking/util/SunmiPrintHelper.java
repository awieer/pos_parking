package com.example.pos_parking.util;
...
import com.example.pos_parking.R;
...
//            printExample(context);
     ...
     */
    public void printExample(Context context, String pbt, String plate, String id, String createdAt, String name, String pass, String price){
        ...
        try {
            ...
            sunmiPrinterService.printText(pbt+"\n", null);

            sunmiPrinterService.printText("RESIT BELIAN KUPON\n\n", null);
            ...
            sunmiPrinterService.printText(plate+"\n\n", null);
            ...
            try {
                sunmiPrinterService.setPrinterStyle(WoyouConsts.SET_LINE_SPACING, 1);
            } catch (RemoteException e) {
            ...
            String txts[] = new String[]{"ID#: "+id, createdAt};
            int width[] = new int[]{1, 2};
            int align[] = new int[]{0, 2};
            sunmiPrinterService.printColumnsString(txts, width, align, null);

            sunmiPrinterService.printText("Penguatkuasa: "+name+"\n", null);
...
//            sunmiPrinterService.printText("谢谢惠顾", null);
    ...
    public void printKompaun(Context context, String pbt, String plate, String id, String createdAt, String name, String pass, String price, String total){
        ...
        try {
            ...
            sunmiPrinterService.printText("RESIT BAYARAN KOMPAUN\n\n", null);
            sunmiPrinterService.setFontSize(36, null);
            try {
                sunmiPrinterService.setPrinterStyle(WoyouConsts.ENABLE_BOLD, WoyouConsts.ENABLE);
            } catch (RemoteException e) {
            ...
            String[] refNo = pass.split(",");
            String[] priceList = price.split(",");

            for(int i = 0; i < refNo.length; i++){

                txts[0] = refNo[i];
                txts[1] = "RM"+priceList[i];
                width[0] = 2;
                width[1] = 1;
                sunmiPrinterService.printColumnsString(txts, width, align, null);
            ...
            String kuantiti = Integer.toString(refNo.length);
            txts[0] = "Kuantiti";
            txts[1] = kuantiti;
            width[0] = 2;
            width[1] = 1;
...
//            sunmiPrinterService.printText("谢谢惠顾", null);
    ...
    public void printCetak(Context context, String pbt, String plate, String id, String createdAt, String name, String pass, String price, String total){
        ...
        try {
            ...
            sunmiPrinterService.printText("SENARAI KOMPAUN\n\n", null);
            sunmiPrinterService.setFontSize(36, null);
            try {
                sunmiPrinterService.setPrinterStyle(WoyouConsts.ENABLE_BOLD, WoyouConsts.ENABLE);
            } catch (RemoteException e) {
