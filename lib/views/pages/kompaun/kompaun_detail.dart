...
class KompaunDetail extends StatefulWidget {
  final KompaunData kompaun;

  KompaunDetail(this.kompaun);
  @override
  _KompaunDetailState createState() => _KompaunDetailState();
}

class _KompaunDetailState extends State<KompaunDetail> {
  formatDate(date) {
            ...
            child: Container(
              child: Column(children: <Widget>[
                ...
                Row(children: <Widget>[
                  ...
                  SizedBox(width: 5),
                  Text(
                    widget.kompaun.registrationNumber,
                    style: TextStyle(fontSize: 17),
                  ),
                ]),
                SizedBox(height: 16),
